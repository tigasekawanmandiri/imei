...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="body">
                <form action="{{ route('admin.bank.update',$bank->id)}}" id="basic-form" method="post" novalidate>
                    @csrf
                    <div class="form-group">
                        <label>Nama Pemilik</label>
                        <input type="text" name="nama_pemilik" value="{{ $bank->nama_pemilik}}" class="form-control" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="no_rek" value="{{ $bank->no_rek}}" class="form-control" required>
                    </div>
                    <br>
