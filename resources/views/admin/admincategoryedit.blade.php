...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="body">
                <form action="{{ route('admin.category.update',$category->id)}}" id="basic-form" method="post" novalidate>
                    @csrf
                    <div class="form-group">
                        <label>Nama Kategori</label>
                        <input type="text" name="nama_kategori" value="{{ $category->category_name}}" class="form-control" required>
                    </div>
                    <br>
