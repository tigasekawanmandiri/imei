...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h2>Input Akun Penjualan Baru</h2>
            </div>
            <div class="body">
                <form action="{{ route('admin.akun.penjualan.create')}}" id="basic-form" method="post" novalidate>
                    @csrf
                    <div class="form-group">
                        <label>Nama Akun</label>
                        <input type="text" name="nama_akun" value="{{ old('nama_akun')}}" class="form-control" required>
                    </div>
                    <br>
            ...
            <div class="body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover js-basic-example dataTable table-custom">
                        ...
                        <tbody>
                            @foreach ($allakunpenjualan as $item)
                            <tr>
