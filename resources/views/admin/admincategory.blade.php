...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="body">
                <form action="{{ route('admin.category.create')}}" id="basic-form" method="post" novalidate>
                    @csrf
                    ...
                    <table class="table table-bordered table-hover js-basic-example dataTable table-custom">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.category.edit', $item->id)}}" class="btn btn-sm btn-primary">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="{{ route('admin.category.destroy', $item->id)}}" class="btn btn-sm btn-danger">
